...
void MainMenu::Init()
{
    m_context->m_assets->AddFont(MAIN_FONT, "assets/fonts/Pacifico-Regular.otf");
    ...
    m_gameTitle.setPosition(m_context->m_window->getSize().x / 2.2,
...
void MainMenu::Draw()
{
    m_context->m_window->clear(sf::Color(0, 100, 0)); // Dark Green
